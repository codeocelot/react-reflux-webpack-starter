...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reflux = __webpack_require__(161);

	var _reflux2 = _interopRequireDefault(_reflux);

	var _refluxApp = __webpack_require__(180);

	var _refluxApp2 = _interopRequireDefault(_refluxApp);
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          'h3',
	          null,
	          'If you see this, ready to get started with React + Reflux + Webpack :)'
	        ),
	        _react2.default.createElement(
	          'h4',
	          null,
	          ...
	          _react2.default.createElement(
	            'a',
	            { href: 'https://github.com/codeocelot/react-webkit-starter/' },
	            'Read me'
	          ),
	          ' yet?'
	        ),
	        _react2.default.createElement(_refluxApp2.default, null)
	      );
	    }
	  }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	Reflux.connect = __webpack_require__(175);

	Reflux.connectFilter = __webpack_require__(177);

	Reflux.ListenerMixin = __webpack_require__(176);

	Reflux.listenTo = __webpack_require__(178);

	Reflux.listenToMany = __webpack_require__(179);
...
/***/ function(module, exports, __webpack_require__) {
	...
	Reflux.ActionMethods = __webpack_require__(163);

	Reflux.ListenerMethods = __webpack_require__(164);

	Reflux.PublisherMethods = __webpack_require__(173);

	Reflux.StoreMethods = __webpack_require__(172);

	Reflux.createAction = __webpack_require__(174);

	Reflux.createStore = __webpack_require__(168);

	var maker = __webpack_require__(167).staticJoinCreator;
	...
	var _ = Reflux.utils = __webpack_require__(165);
	...
	Reflux.__keep = __webpack_require__(169);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ = __webpack_require__(165),
	    maker = __webpack_require__(167).instanceJoinCreator;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var createStore = __webpack_require__(168),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ = __webpack_require__(165),
	    Keep = __webpack_require__(169),
	    mixer = __webpack_require__(170),
	    bindMethods = __webpack_require__(171);
	...
	module.exports = function (definition) {
	    ...
	    var StoreMethods = __webpack_require__(172),
	        PublisherMethods = __webpack_require__(173),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ = __webpack_require__(165),
	    ActionMethods = __webpack_require__(163),
	    PublisherMethods = __webpack_require__(173),
	    Keep = __webpack_require__(169);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ListenerMethods = __webpack_require__(164),
	    ListenerMixin = __webpack_require__(176),
	    _ = __webpack_require__(165);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _myFirstActions = __webpack_require__(181);

	var _myFirstActions2 = _interopRequireDefault(_myFirstActions);

	var _myFirstStore = __webpack_require__(182);

	var _myFirstStore2 = _interopRequireDefault(_myFirstStore);
	...
	var RefluxApp = (function (_React$Component) {
	  _inherits(RefluxApp, _React$Component);

	  function RefluxApp(props) {
	    _classCallCheck(this, RefluxApp);

	    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(RefluxApp).call(this, props));
	  ...
	  _createClass(RefluxApp, [{
	    key: 'componentDidMount',
	    value: function componentDidMount() {
	      var _this2 = this;

	      _myFirstStore2.default.listen(function (items) {
	    ...
	    value: function handleAdd() {
	      ...
	      _myFirstActions2.default.add({ content: content });
	      this.refs.userInput.value = '';
	    }
	  }, {
	    key: 'handleRemove',
	    value: function handleRemove(id) {
	      _myFirstActions2.default.remove(id);
	    }
	  }, {
	    key: 'render',
	    value: function render() {
	      ...
	      var items = this.state.items.map(function (item) {
	        return _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            'button',
	            { type: 'button', className: 'btn-rm', onClick: _this3.handleRemove.bind(_this3, item.id) },
	            ' Remove '
	          )
	        );
	      });
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          'label',
	          { htmlFor: 'input' },
	          'Enter some text to add to store'
	        ),
	        _react2.default.createElement('input', { type: 'text', ref: 'userInput', name: 'input' }),
	        _react2.default.createElement(
	          'button',
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = _reflux2.default.createActions(['add', 'remove']);
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = _reflux2.default.createStore({
	  init: function init() {
	    this.objs = [];
	    this.currId = 0;
	    this.listenToMany(_myFirstActions2.default);
	  },
	  ...
	  onRemove: function onRemove(id) {
	    this.objs = _underscore2.default.without(this.objs, _underscore2.default.findWhere(this.objs, { id: id }));
	    this.trigger(this.objs);
	  }
	});
